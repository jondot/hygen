...
var hygenChain = utils_1.createResolverChain(masterResolvers);
exports.hygen = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        hygenChain(config).catch(function (err) {
            if (config.logger) {
