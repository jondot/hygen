...
var helpModule_1 = __importDefault(require("../helpModule"));
describe('helpModuleResolver', function () {
    describe('Basics', function () {
        it('should be a function', function () {
            expect(typeof helpModule_1.default).toEqual('function');
        });
        // does it accept all of the various parameter signatures it needs
        // does it return the correct data
    });
    describe('helpModuleResolver(config: HygenConfig): HygenConfig', function () {
        // happy path
