...
exports.resolveYargs = config => {
    const yargv = yargs(config.env.argv)
        ...
        .command('$0 <generator> <action | action:subaction> [name]', 'generate templates from generator/action', 
    //@ts-ignore
    yargs => {
        yargs
    ...
    common_1.resolveCustomYargs(config.yargs)(yargv);
    ...
    const args = Object.assign(Object.assign({}, yargv.argv), (config.args || {}));
    config.args = args;
